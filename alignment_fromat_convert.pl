#!/usr/bin/perl
use Getopt::Long;
use Bio::AlignIO;               ##### you need to install BioPerl package firstly

##### original scripts were found here https://github.com/JinfengChen/Scripts/blob/master/bin/AlignIO.pl
